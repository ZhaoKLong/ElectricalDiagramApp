...
public class PrintModule extends ReactContextBaseJavaModule {
    ...
    //    private static PrintModule mPrintModule = new PrintModule();
    private Context context;

    PrintModule(ReactApplicationContext reactContext) {
        super(reactContext);
        connectPrinterService(reactContext);
    }
...
//    }
     ...
     */
    @ReactMethod
    public void printQr(String data, int modulesize, int errorlevel, int align) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
...
//            woyouService.lineWrap(1, null);
     ...
     */
    @ReactMethod
    public void printBitmap(String url) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
